...
# Same as Cmd 20 that was using %fs
# But this would allow me to do 'for' loop to look for certain files
...
# MAGIC 
# MAGIC -- Go to 'Data' tab to view Table
# MAGIC -- To view DB,    type: display(spark.catalog.listDatabases())
# MAGIC -- To view Table, type: print(spark.catalog.listTables())
# MAGIC --%sql
# MAGIC -- Bonus Cell (using 'LOCATION' keyword)
# MAGIC --CREATE TABLE IF NOT EXISTS events2 
# MAGIC --USING parquet 
# MAGIC --LOCATION "/mnt/training/ecommerce/events/events.parquet";
...
# MAGIC %sql
# MAGIC -- Comment: Try a Pie Chart too
...
# Text Comment:         1st arg = Widget name, 2nd arg = Default value, 3rd arg = Caption name
# Multiselect Comment:  1st arg = Widget name, 2nd arg = Default value, 3rd arg = Other values, 4th = Caption name
...
# Want to write widgets in Python?  Here's help
dbutils.widgets.help()

# COMMAND ----------

# Here's the 4 Widget types
